	...
	<div class="header">
		<div class="container">
			<div class="header-top">
				<div class="logo">
					<a href="index.html"><h2>RestoEat</h2></a>
				</div>
			...
			<div class="banner_wrap">
				<div class="bannertop_box">
					<div class="search">
						<input type="text" value="Search Restaurants" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search Restaurants';}">
						<input type="submit" value="">
					</div>
					<div class="welcome_box">
						<h3>Welcome To RestoEat</h3>
				...
				<div class="banner_right">
					<h1>Find Local Restaurants <br>Like Never Before</h1>
					<p>Find and Book restaurants anywhere. More than 1400 restaurants in 120 Countries. </p>
					<a href="#" class="banner_btn">Book a Table Now</a>
				</div>
				<div class='clearfix'></div>
			</div>
		</div>
